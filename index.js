...
const displayStr = `A total of $${totalRaised.toLocaleString("en-US")} has been raised for ${totalGames} games. Currently, ${numUnfundedGames} game${numUnfundedGames === 1 ? "" : "s"} remain${numUnfundedGames === 1 ? "s" : ""} unfunded. We need your help to fund these amazing games!`;
...
const runnerGameElement = document.createElement("h2");
runnerGameElement.textContent = secondGame.name;
